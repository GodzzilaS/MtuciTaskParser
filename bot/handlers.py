...
COURSES_MAP = {
    "Бакалавариат": {
        ...
        "Заочная": {
            "Центр индивидуального обучения": ["Первый", "Второй", "Третий", "Четвёртый"],
            "Центр заочного обучения по программам бакалавриата": ["Первый", "Второй", "Третий", "Четвёртый", "Пятый"]
        }
    },
    "Магистратура": {
        "Очная": {
        ...
        "Заочная": {
            ...
            "Центр заочного обучения по программам магистратуры": ["Первый", "Второй", "Третий", "Четвёртый", "Пятый"]
        }
    },
    "Специалитет": {
        "Очная": {
